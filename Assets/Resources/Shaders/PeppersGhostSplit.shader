Shader "Custom/PeppersGhostSplit"
{
    ...
    SubShader
    {
        Name "PeppersGhostSplit"
        Tags {"RenderPipeline"="UniversalPipeline" "Queue"="Transparent" "RenderType"="Transparent" } //transparent means it renders after all opaque 
        ...
        Pass
        {
            Tags {"LightMode"="Universal2D"} //used to be Universal2D
