...
public class SineWaveMinigame : MonoBehaviour
{
    ...
    [SerializeField] private float amplitudeChangeSpeed = 1f;
    [SerializeField] private float shiftChangeSpeed = 1f;
    ...
    [Header("Matching")]
    [SerializeField] private float matchTolerance = 0.3f;
    [SerializeField] private float matchTimeRequired = 1f; 
    ...
    void Start()
    {
        MinigameProgressManager manager = MinigameProgressManager.Instance;
        if (manager != null)
        {
            manager.SetMinigameStarted();
        }
    ...
    void CompleteMinigame()
    {
        ...
        Debug.Log("Sine wave match");
        MinigameProgressManager manager = MinigameProgressManager.Instance;
        if (manager != null)
        {
            manager.SetMinigameCompleted();
        }
